...
<template>
    <div class="">
        ...
        <p class="text-[16px] mt-5 text-center ">L’opération de reversement du compte business <b>Open SI SAS</b> a <br> été
            effectué avec succès !</p>
        ...
        <div class="flex justify-center space-x-4 mt-12">
            <div class="rounded border-2 border-red-500 w-52 h-10  py-2  flex justify-center">
